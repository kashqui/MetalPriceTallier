========================================================================
    アプリケーション: MetalPriceTallier プロジェクトの概要
========================================================================

この MetalPriceTallier アプリケーションは、AppWizard により作成されました。  

このファイルには、MetalPriceTallier 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

MetalPriceTallier.vcxproj
...
MetalPriceTallier.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、MetalPriceTallier.pch 
